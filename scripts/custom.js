$(document).ready(function() {
  ...
  function init_template() { //Class is vital to run AJAX Pages
    ...
    function calculate_menu() {
      ...
      $('.footer-menu-scroll').animate({
        scrollTop: scroll_footer
      }, 0);
    ...
    if ($("#copyright-year-sidebar")[0]) {
      document.getElementById('copyright-year-sidebar').appendChild(document.createTextNode(new Date().getFullYear()))
    }
    ...
    //Interests
    /**
     * START - Change by Hitesh Solanki - to support single and multiple option selction
     */
    ...
    /* Added by HS - this class should be used for multiple choice answers */
    $('.interest-box-multiple-choice').click(function() {
      console.log('multiple-choice click');
      $(this).toggleClass('transparent-background');
      $(this).find('.interest-first-icon, .interest-second-icon').toggleClass('hide-interest-icon');
      return false;
    });

    /* Added by HS - this class should be used for single choice answers */
    $('.interest-box-single-choice').click(function() {
      $(".interest-box-single-choice").each(function(index) {
        if (!$(this).hasClass('transparent-background')) {
          $(this).toggleClass('transparent-background');
          $(this).find('.interest-first-icon, .interest-second-icon').toggleClass('hide-interest-icon');
        }
      });
